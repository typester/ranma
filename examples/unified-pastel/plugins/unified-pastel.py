...
"""Pastel (Catppuccin Mocha) status bar plugin for ranma.

Soft dark purple background with pastel accent colors.
Inspired by the Catppuccin Mocha color palette.
"""
...
SEP_COLOR = "#45475a30"        # Surface1
SHADOW_COLOR = "#11111b60"     # Crust

# Status colors — Catppuccin Mocha
GREEN = "#a6e3a1"              # Green
ORANGE = "#fab387"             # Peach
RED = "#f38ba8"                # Red (Maroon/Pink)

# Accent
NP_ICON_COLOR = "#cba6f7"     # Mauve
PRIV_CAM_COLOR = "#a6e3a1"    # Green
PRIV_MIC_COLOR = "#fab387"    # Peach
