...
"""Retro Terminal status bar plugin for ranma.

Black background with green monospace text.
Sharp corners, no shadows. Classic terminal/hacker aesthetic.
"""
...
BG_COLOR = "#0a0a0a"
BORDER = "#33ff0040"
TEXT_PRIMARY = "#33ff00"       # Phosphor green
TEXT_SECONDARY = "#33ff0070"
SEP_COLOR = "#33ff0025"
SHADOW_COLOR = "#00000000"     # No shadow

# Status — monochrome green shades
GREEN = "#33ff00"
ORANGE = "#ccff00"             # Yellow-green for warnings
RED = "#ff3300"                # Red stands out against green

# Accent
NP_ICON_COLOR = "#33ff00"
PRIV_CAM_COLOR = "#33ff00"
PRIV_MIC_COLOR = "#ccff00"
...
def update_clock():
    ...
    ranma_set("bar.date", label=now.strftime("%a %d").upper())
...
def update_wifi(script):
    ...
    if not info["power"]:
        ...
        ranma_set("bar.wifi.icon", icon="wifi.slash", icon_color=TEXT_SECONDARY)
